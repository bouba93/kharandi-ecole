import { SchoolClass, Student, Subject, Grade, AttendanceRecord, LogbookEntry, PaymentTransaction, ParentAlert } from '../types';
...
export const INITIAL_STUDENTS: Student[] = [
  {
    ...
    tuitionTotal: 1800000, // 1 800 000 GNF/an (incl. 60 000 GNF Kharandi)
    tuitionPaid: 1800000,
    status: 'En règle',
  },
  {
...
export const INITIAL_ALERTS: ParentAlert[] = [
  ...
  },
  {
    ...
    message: 'Kharandi École : Cher parent, la 2ème tranche de scolarité pour Mohamed Lamine Conde (600 000 GNF) est en retard. Vous pouvez régler facilement via Orange Money au +224 628 00 11 22.',
